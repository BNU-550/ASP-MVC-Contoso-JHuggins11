...
namespace ASP_MVC_Contoso.Data
{
    public static class DbInitialiser
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            {
                new Student{FirstName="Taylor",LastName="Hall",EnrolmentDate=DateTime.Parse("2019-09-01")},
                new Student{FirstName="Mark",LastName="Wayne",EnrolmentDate=DateTime.Parse("2017-09-01")},
                new Student{FirstName="Terry",LastName="Dark",EnrolmentDate=DateTime.Parse("2018-09-01")},
                new Student{FirstName="Melissa",LastName="Rayn",EnrolmentDate=DateTime.Parse("2017-09-01")},
                new Student{FirstName="Heather",LastName="Serth",EnrolmentDate=DateTime.Parse("2017-09-01")},
                new Student{FirstName="Liam",LastName="Heard",EnrolmentDate=DateTime.Parse("2016-09-01")},
                new Student{FirstName="Chris",LastName="Kidd",EnrolmentDate=DateTime.Parse("2018-09-01")},
                new Student{FirstName="Patricia",LastName="Rove",EnrolmentDate=DateTime.Parse("2019-09-01")}
            };
